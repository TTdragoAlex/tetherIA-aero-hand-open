...
def brax_ppo_config(
  ...
  if env_name == "AlohaHandOver":
    ...
    rl_config.num_resets_per_eval = 1
  elif env_name in ("AeroCubeRotateZAxis", "AeroCubeRotateZAxisRealObs", "AeroCubeRotateZAxisRealObsParticipation", "AeroCubeRotateZAxisHardwareObs", "AeroCubeRotateZAxisHardware01RealOrder", "AeroCubeRotateZAxisHardware01Randomized", "AeroCubeRotateZAxisHardware01Efficient", "AeroCubeRotateZAxisHardware01RealCalibrated", "AeroCubeRotateZAxisHardware01RealCalibratedSmooth", "AeroCubeRotateZAxisHardware01RealCalibratedAntiTrap", "AeroCubeRotateZAxisHardware01RealCalibratedPhysicsID", "AeroCubeRotateZAxisHardware01RealTunedWindow", "AeroBall45mmRotateZAxisHardware01RealTunedWindow"):
